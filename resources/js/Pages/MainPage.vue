...
<nav class="bg-gradient-to-b from-green-400 to-blue-400
  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3 bg-customgray">
        <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <Link href="/" class="flex ml-2 md:mr-24">
                    <img src="../../../public/partas_logo.png" class="h-8 mr-3" alt="FlowBite Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">QUAD BUS</span>
                    </Link>
                </div>
...
<div class="p-6 dark:border-gray-700 mt-14 bg-blue-400">
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div>
            ...
            <img class="h-auto max-w-full rounded-lg" src="https://placehold.co/600x400?text=IMAGE" alt="Image">
        </div>
        <div>
            ...
            <img class="h-auto max-w-full rounded-lg" src="https://placehold.co/600x400?text=IMAGE" alt="">
        </div>
        <div>
